...
date = 2020-06-20T11:49:41+02:00
card_image = "missing-tool.png"
+++

## Betreuer:in(nen) : Prof. Barne Kleinen
## Teilnehmendennamen: eins zwei drei

## Link zu Ihrer 5-min Präsentation (ggfs. nach der ST, s.u.)
## Link zur Testversion / oder Seite die diese Ersetzt wenn nicht möglich
## Link zum Source sofern möglich(s.u.)/ oder Seite die diese Ersetzt wenn nicht möglich. z.B. Gist über Hugo, dies evtl. auch zusätzlich.
...
## Link auf weitere Seiten mit beliebig viel Inhalt. dies können weitere Markdown-Seiten sein die auf dem allgemeinen Server gehostet werden, oder auch ein Link zu einer eigenen Seite.
